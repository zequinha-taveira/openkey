...
| [Bug Hunting](./bug-hunting/SKILL.md) | Hunt for bugs and problems in code systematically. Use when Searching for bugs proactively, Auditing code for correctness, or Finding potential issues before they manifest | R, E, V |
